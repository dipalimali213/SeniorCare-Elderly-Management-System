    ...
    <%
        if ("POST".equalsIgnoreCase(request.getMethod())) {
            ...
            try {
                ...
                pstmt = con.prepareStatement("SELECT password FROM caretaker WHERE id = ?");
                pstmt.setInt(1, caretakerId);
                ...
                if (rs.next()) {
                    ...
                    if (!existingPass.equals(current)) {
                        ...
                        pstmt.close();
                        pstmt = con.prepareStatement("UPDATE caretaker SET password = ? WHERE id = ?");
